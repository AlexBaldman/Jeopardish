  ...
  class InputController {
    ...
    createRendererBindings() {
      ...
      return {
        ...
        onCycleHostPack: () => dispatch(InputCommands.CYCLE_HOST_PACK),
        onPreviousHostPack: () => dispatch(InputCommands.CYCLE_HOST_PACK, { step: -1 }),
        onNextHostPack: () => dispatch(InputCommands.CYCLE_HOST_PACK, { step: 1 }),
        ...
        onPreviousScene: () => dispatch(InputCommands.CYCLE_SCENE, { step: -1 }),
        onNextScene: () => dispatch(InputCommands.CYCLE_SCENE, { step: 1 }),
        onCycleControlSkin: () => dispatch(InputCommands.CYCLE_CONTROL_SKIN),
        onPreviousControlSkin: () => dispatch(InputCommands.CYCLE_CONTROL_SKIN, { step: -1 }),
        onNextControlSkin: () => dispatch(InputCommands.CYCLE_CONTROL_SKIN, { step: 1 }),
