...
// Helper function to animate score updates
...
function updateScoreboard() {
    ...
    // Update Score
    if (scoreEl && parseInt(scoreEl.textContent) !== currentScore) {
        scoreEl.textContent = currentScore;
        animateScoreUpdate(scoreEl);
    }

    // Update Streak
    if (streakEl && parseInt(streakEl.textContent) !== currentStreak) {
        streakEl.textContent = currentStreak;
        animateScoreUpdate(streakEl);
    }

    // Update Top Score
    if (topScoreEl && parseInt(topScoreEl.textContent) !== topScore) {
        topScoreEl.textContent = topScore;
        animateScoreUpdate(topScoreEl);
    }

    // Update Max Streak
    if (maxStreakEl && parseInt(maxStreakEl.textContent) !== maxStreak) {
        maxStreakEl.textContent = maxStreak;
        animateScoreUpdate(maxStreakEl);
    }
}
